#line 1 "..\\..\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
#line 24 "..\\..\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
#line 25 "..\\..\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
#line 26 "..\\..\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 27 "..\\..\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
i2c_error_code i2c_wait_until_eeprom_ready(void)
{
    ...
    for (uint32_t i = 0; i < (200000); i++)
    {
        ...
        while(((* ( volatile uint16*)((0x50001370)) ) & (0x0020)) !=0);                        
        tx_abrt_source = (* ( volatile uint16*)((0x50001380)) );     
        (* ( volatile uint16*)((0x50001354)) );                         
        if ((tx_abrt_source & (0x0001)) == 0)
        {
            return I2C_NO_ERROR;
        }
    }
...
static void i2c_send_address(uint32_t address)
{
    switch(mem_address_size)
    {
        case I2C_2BYTES_ADDR:
             (* ( volatile uint16*)((0x5000136C))=(0x0) );
             (* ( volatile uint16*)((0x50001304))=(i2c_dev_address | ((address & 0x10000) >> 16)) );  
             (* ( volatile uint16*)((0x5000136C))=(0x1) );
             while(((* ( volatile uint16*)((0x50001370)) ) & (0x0020)) !=0);            
             (* ( volatile uint16*)((0x50001310))=(((address >> 8) & 0xFF)) );    
             break;

        case I2C_3BYTES_ADDR:
             (* ( volatile uint16*)((0x50001310))=(((address >> 16) & 0xFF)) );   
             (* ( volatile uint16*)((0x50001310))=(((address >> 8) & 0xFF)) );    
             break;
    }

    (* ( volatile uint16*)((0x50001310))=((address & 0xFF)) );                    
}
...
i2c_error_code i2c_eeprom_read_byte(uint32_t address, uint8_t *byte)
{
    ...
    *byte = 0xFF & (* ( volatile uint16*)((0x50001310)) );     
...
i2c_error_code i2c_eeprom_write_byte(uint32_t address, uint8_t byte)
{
    ...
    (* ( volatile uint16*)((0x50001310))=((byte & 0xFF)) );                  
...
i2c_error_code i2c_eeprom_write_data(uint8_t *wr_data_ptr, uint32_t address, uint32_t size, uint32_t *bytes_written)
{
    *bytes_written = 0;
    ...
    if (address >= 0x20000)
    {
        return I2C_INVALID_EEPROM_ADDRESS;          
    }
